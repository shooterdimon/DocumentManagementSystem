...
Основний сценарій:
   ...
   іншої інформації, яка може полегшити пошук та навігаціюсеред документів.
...
## 3.1 Незареєстрований користувач
...
## 3.2 Зареєстрований користувач
   ...
   1. Всі можливості незареєстрованого користувача
   2. Власний кабінет з додатковими функціями (мої файли, вибране тощо)
